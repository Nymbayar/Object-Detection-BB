...
def clip_boxes_graph(boxes, window):
    ...
    wy1, wx1, wy2, wx2 = wy1.astype(np.float32), wx1.astype(np.float32), wy2.astype(np.float32), wx2.astype(np.float32)
    y1, x1, y2, x2 = y1.astype(np.float32), x1.astype(np.float32), y2.astype(np.float32), x2.astype(np.float32)
    # Clip
